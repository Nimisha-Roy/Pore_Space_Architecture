function step6_vtkwrite( filename,dataType,varargin )
% This function writes a structured 3D vector data in .vtk format for visualization in Paraview. It is a post-processing step of the algorithm
